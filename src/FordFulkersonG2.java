...
public class FordFulkersonG2 {
    //In this program, the source vertex s => 0, a => 1, b => 2, c => 3, d => 4, e => 5, f => 6 and the sink, t => 7

    static String [] vertex = {"s", "a", "b","c", "d", "e", "f", "t",};
    ...
    public static void main(String args[]) {
        ...
        System.out.println( "\nThe capacity of the minimum cut c(S, T) of the input flow network G2 is = " + totalMinCutCapacity);
        System.out.println("\n set S = " + S);
        System.out.println("\n set T = " + T);
    }
